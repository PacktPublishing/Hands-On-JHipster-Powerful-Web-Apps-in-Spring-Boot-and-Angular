...
class JhipsterApp(private val env: Environment) : InitializingBean {

    private val log = LoggerFactory.getLogger(JhipsterApp::class.java)
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<JhipsterApp>(*args) {
