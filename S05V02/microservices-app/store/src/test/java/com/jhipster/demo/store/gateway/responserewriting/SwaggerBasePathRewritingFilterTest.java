package com.jhipster.demo.store.gateway.responserewriting;
...
import static com.jhipster.demo.store.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
